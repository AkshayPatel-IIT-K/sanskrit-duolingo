      ...
      <div style={{width:720,maxWidth:'94%',borderRadius:12,background:'#fffefa',padding:18,border:'1px solid #e8d9bd'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          <div>
            ...
            <div style={{fontSize:13,color:'#6d5a43'}}>oxakshaypatel@gmail.com</div>
          </div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginTop:12}}>
          <div style={{padding:12,borderRadius:8,background:'#fff9f0',border:'1px solid #e8d9bd'}}>
            <div style={{fontSize:13,color:'#6d5a43'}}>Total XP</div>
            <div style={{fontWeight:900,fontSize:22}}>{xp}</div>
            <div style={{marginTop:8,color:'#6d5a43'}}>Level {level}</div>
          </div>
          <div style={{padding:12,borderRadius:8,background:'#fff9f0',border:'1px solid #e8d9bd'}}>
            <div style={{fontSize:13,color:'#6d5a43'}}>Daily Streak</div>
          ...
          <div style={{gridColumn:'1 / -1',display:'flex',gap:8,marginTop:8}}>
            <button style={{padding:10}}>Export Profile</button>
            <button style={{padding:10,background:'#fde7e7'}}>Reset Progress</button>
          </div>
        </div>
      </div>
    </div>
